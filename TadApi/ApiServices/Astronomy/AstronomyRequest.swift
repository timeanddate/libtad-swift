...
/// For more information, see [astronomy – Get Information About Astronomical Objects](https://services.timeanddate.com/api/doc/current/srv-astronomy.html)
/// ````
...
public class AstronomyRequest: RequestObject {
    ...
    /**
     ...
     - Type: String/[Astronomical Object Id .](https://services.timeanddate.com/api/doc/current/srv-astronomy.html)
    ...
    /**
     ...
     - Type: String/[Location Id ](https://services.timeanddate.com/api/doc/current/type-locationid.html)
     - This parameter required!
     */
    ...
    /**
     ...
     - Type: String/[ISO8601 Date ](https://services.timeanddate.com/api/doc/current/type-isodate.html)
     - This parameter required!
     */
    ...
    /**
     ...
     - Type: String/[IAstronomy Event Class ](https://services.timeanddate.com/api/doc/current/type-astroeventclass.html)
     - This parameter Optional!
     */
